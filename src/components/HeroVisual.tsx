export function HeroVisual() {
  return (
    <div className="hero-star-field relative mx-auto w-full max-w-[42rem]" data-section="hero-visual">
      <div className="hero-image-stage relative mx-auto aspect-square w-full max-w-[34rem]">
        <span className="hero-electric hero-electric-a" aria-hidden="true" />
        ...
        <span className="hero-spark hero-spark-d right-[19%] bottom-[14%]" aria-hidden="true" />
        <span className="hero-spark hero-spark-e left-[47%] top-[6%]" aria-hidden="true" />
        ...
        <img
          ...
          src="/visuals/navines-purple-tech-star-clean.png"
        />
      </div>
    </div>
  );
