...
export function HeroVisual() {
  return (
    <div
      className="star-stage hero-star-field relative overflow-hidden rounded-[2.6rem] border border-purple-300/20 bg-[radial-gradient(circle_at_50%_42%,rgba(168,85,247,0.08),transparent_14rem),linear-gradient(145deg,rgba(3,3,5,0.99),rgba(0,0,0,0.98))] p-5 shadow-premium sm:p-7"
