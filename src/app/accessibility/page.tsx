  ...
  return (
    <Section eyebrow="נגישות" title="הצהרת נגישות" titleAs="h1">
      <div className="grid gap-6 text-lg leading-8 text-zinc-300">
        ...
        <p>
          אם נתקלתם בקושי נגישות, ניתן לפנות אלינו במייל <span className="english-tech">{site.email}</span>, בטלפון <span className="english-tech">{site.phone}</span>, או בכתובת {site.hebrewAddress}.
        </p>
