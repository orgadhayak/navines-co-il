...
export const metadata = createMetadata({ title: "הצהרת נגישות", description: "הצהרת נגישות בעברית עבור אתר NAVINES ישראל.", path: "/accessibility" });

export default function AccessibilityPage() {
  return (
    <Section eyebrow="נגישות" title="הצהרת נגישות" titleAs="h1">
      <div className="grid gap-6 text-lg leading-8 text-zinc-300">
        <p>NAVINES ישראל מחויבת להנגשת האתר ככל הניתן ולשימוש נוח וברור עבור כלל המשתמשים.</p>
