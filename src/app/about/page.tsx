...
export const metadata = createMetadata({
  title: "אודות",
  description: "נביא נס ישראל בע״מ היא חברת טכנולוגיה שמחברת בין פיתוח, בינה מלאכותית, אוטומציה, איקומרס ותשתיות כדי לעזור לעסקים לעבוד חכם יותר.",
  path: "/about",
});
    ...
    <>
      <Section eyebrow="אודות" title="אנחנו עוזרים לעסקים להפוך טכנולוגיה לעבודה מסודרת יותר" titleAs="h1">
        <div className="grid gap-6 text-lg leading-8 text-zinc-300 lg:grid-cols-3">
          <p>נביא נס ישראל בע״מ היא חברת טכנולוגיה לעסקים שרוצים אתר, חנות, מערכת או אוטומציה שבאמת עוזרים לתפעול ולמכירות. אנחנו משלבים פיתוח, בינה מלאכותית, איקומרס, אבטחה, ביצועים וקידום אורגני בצורה שמשרתת מטרה עסקית ברורה.</p>
