...
export const metadata = createMetadata({
  title: "אודות",
  description: "נביא נס ישראל היא חברת טכנולוגיה שמתמחה בפיתוח אתרים, מערכות, אוטומציות, כלי בינה מלאכותית ותשתיות דיגיטליות לעסקים.",
  path: "/about",
});
    ...
    <>
      <Section eyebrow="אודות" title="אנחנו בונים את התשתית הדיגיטלית שמאחורי עסקים חכמים" titleAs="h1">
        <div className="grid gap-6 text-lg leading-8 text-zinc-300 lg:grid-cols-3">
          <p>נביא נס ישראל היא חברת טכנולוגיה שמתמחה בפיתוח אתרים, מערכות, אוטומציות, כלי בינה מלאכותית ותשתיות דיגיטליות לעסקים. אנחנו משלבים חשיבה עסקית עם יכולות פיתוח, איקומרס, אבטחה, ביצועים, קידום אורגני ואינטגרציות.</p>
          ...
          <p>אתר טוב הוא לא רק עיצוב יפה. הוא צריך לטעון מהר, לעבוד במובייל, להביא פניות, לשדר אמון, להתחבר למערכות ולהישאר יציב לאורך זמן.</p>
        </div>
      </Section>
