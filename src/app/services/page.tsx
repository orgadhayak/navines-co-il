  ...
  return (
    <>
      ...
      {musicDistributionService ? (
        <div className="mt-8 border-y py-7 lg:flex lg:items-end lg:justify-between lg:gap-10" style={{ borderColor: "var(--border)" }}>
          <div className="max-w-4xl">
            <p className="text-sm font-semibold text-glowred">מוזיקה, הפצה וניהול אמן</p>
            <h2 className="mt-2 text-3xl font-semibold leading-tight text-white">{musicDistributionService.title}</h2>
            <p className="mt-3 text-lg leading-8 text-zinc-300">{musicDistributionService.summary}</p>
          </div>
      ...
      {robloxExperienceService ? (
        <div className="mt-8 border-y py-7 lg:flex lg:items-end lg:justify-between lg:gap-10" style={{ borderColor: "var(--border)" }}>
          <div className="max-w-4xl">
            <p className="text-sm font-semibold text-glowred">משחקים ועולמות מותג אינטראקטיביים</p>
            <h2 className="mt-2 text-3xl font-semibold leading-tight text-white">{robloxExperienceService.title}</h2>
            <p className="mt-3 text-lg leading-8 text-zinc-300">{robloxExperienceService.summary}</p>
          </div>
          <div className="mt-5 flex shrink-0 flex-wrap gap-3 lg:mt-0">
