    ...
    <>
      <Section eyebrow="כלים שימושיים בעברית" title="בדיקה קטנה לפני פעולה גדולה" titleAs="h1">
        <p className="max-w-4xl text-lg leading-8 text-zinc-300">
          בנינו 21 כלים קצרים שעוזרים לעצור לרגע לפני שלוחצים, סורקים QR, מגיבים, מאשרים תשלום, מתכננים שינוי באתר, עולים עם קמפיין או מטפלים באירוע דיגיטלי. הם פועלים בדפדפן, בעברית, בלי הרשמה ובלי לשלוח את הקלט לשרת. התוצאות הן סימנים לבדיקה, לא הבטחה שהקישור, ההודעה או הבקשה בטוחים.
        </p>
        <HebrewToolsClient />
      </Section>
