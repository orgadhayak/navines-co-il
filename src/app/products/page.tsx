...
export const metadata = createMetadata({
  title: "כלים ומוצרים",
  description: "כלים ומוצרים מבית נביא נס שעוזרים לעסקים לראות טוב יותר, לזהות בעיות מוקדם ולקבל החלטות חכמות.",
  path: "/products",
});
...
export default function ProductsPage() {
  return (
    <>
      <Section eyebrow="כלים ומוצרים" title="כלים ומוצרים מבית נביא נס" titleAs="h1">
