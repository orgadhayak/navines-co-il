...
export const metadata: Metadata = {
  ...
  applicationName: "נביא נס ישראל",
  title: {
    default: "נביא נס ישראל בע\"מ | AI, אוטומציה ותשתיות דיגיטליות",
    template: "%s | נביא נס ישראל",
  },
  description: "נביא נס ישראל בע\"מ בונה מערכות AI, אתרים, אוטומציות, חנויות ותשתיות דיגיטליות לעסקים בישראל.",
  keywords: ["נביא נס ישראל", "NAVINES", "AI לעסקים", "אוטומציה", "בניית אתרים", "איקומרס", "תשתיות דיגיטליות"],
  ...
  openGraph: {
    title: "נביא נס ישראל בע\"מ | AI, אוטומציה ותשתיות דיגיטליות",
    description: "אתר נביא נס ישראל הרשמי: מערכות AI, אתרים, אוטומציה, איקומרס ותשתיות דיגיטליות לעסקים.",
    url: "https://www.navines.co.il",
    siteName: "נביא נס ישראל",
    locale: "he_IL",
    type: "website",
