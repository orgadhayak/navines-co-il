...
export const metadata: Metadata = {
  ...
  keywords: ["נביא נס ישראל", "NAVINES", "בינה מלאכותית לעסקים", "אוטומציה", "בניית אתרים", "איקומרס", "תשתיות דיגיטליות", "קידום אורגני"],
  ...
  openGraph: {
    ...
    description: "אתר נביא נס ישראל הרשמי: מערכות בינה מלאכותית, אתרים, אוטומציה, איקומרס ותשתיות דיגיטליות לעסקים.",
