...
export default function BlogPage() {
  return (
    <Section eyebrow="בלוג" title="מאמרים, תובנות וכלים לעסקים דיגיטליים" titleAs="h1">
      ...
      <div className="mb-10 border-y py-7" style={{ borderColor: "var(--border)" }}>
        <p className="text-base font-semibold text-glowred">ידע מעשי לעסקים בישראל</p>
        <h2 className="mt-2 max-w-3xl text-3xl font-semibold leading-tight text-white">תוכן שעוזר להבין מה כדאי לעשות עכשיו</h2>
