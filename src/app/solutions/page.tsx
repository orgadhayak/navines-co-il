...
export const metadata = createMetadata({
  ...
  description:
    "פתרונות AI, אוטומציה, דאטה ותשתיות דיגיטליות לרואי חשבון, מוכרי אמזון ופרילנסרים. נביא נס ישראל בע\"מ מחברת נתונים, מערכות ודוחות לממשקי עבודה חכמים.",
  path: "/solutions",
});
    ...
    <>
      ...
      <Section eyebrow="פתרונות לפי סוג עסק" title="מערכות חכמות שמדברות בשפה של העסק שלכם" titleAs="h1">
        <p className="max-w-4xl text-lg leading-8 text-zinc-300">
          לא כל עסק צריך את אותה מערכת. משרד רואי חשבון, מוכר אמזון ופרילנסר עובדים אחרת, שואלים שאלות אחרות
